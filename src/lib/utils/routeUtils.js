...
const INTENT_ROUTE_CONFIG = {
  ...
  institute_submit: {
    primary: '/drives',
    allowed: ['/drives', '/drives/*', '/institute/submit-excel', '/cadets/view/*', '/notifications'],
  },
  institute_shortlist: {
    primary: '/drives',
    allowed: ['/cadets/fill-details/*', '/cadets/view/*', '/drives', '/drives/*', '/institute/shortlisted-cadets', '/notifications'],
  },
};
