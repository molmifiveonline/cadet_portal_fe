...
//   const physics = watch('twelfth_std_physics');
//   const chemistry = watch('twelfth_std_chemistry');
//   const maths = watch('twelfth_std_maths');

//   // Watch fields for IMU Average calculation
//   const imu_sem_1_percentage1 = watch('imu_sem_2_percentage1');
//   const imu_sem_3_percentage2 = watch('imu_sem_4_percentage2');
//   const imu_sem_5_percentage3 = watch('imu_sem_6_percentage3');
//   const imu_sem_7_percentage4 = watch('imu_sem_8_percentage4');
//   const imu_sem_1_percentage5 = watch('imu_sem_2_percentage5');
//   const imu_sem_3_percentage6 = watch('imu_sem_4_percentage6');
//   const imu_sem_5_percentage7 = watch('imu_sem_6_percentage7');
//   const imu_sem_7_percentage8 = watch('imu_sem_8_percentage8');
...
//   React.useEffect(() => {
//     const sems = [
//       imu_sem_1_percentage1,
//       imu_sem_2_percentage2,
//       imu_sem_3_percentage3,
//       imu_sem_4_percentage4,
//       imu_sem_5_percentage5,
//       imu_sem_6_percentage6,
//       imu_sem_7_percentage7,
//       imu_sem_8_percentage8,
//     ];
...
//       setValue('imu_avg_all_semester_percentage', avg.toString());
//     } else {
//       setValue('imu_avg_all_semester_percentage', '');
//     }
//   }, [
//     imu_sem_1_percentage1,
//     imu_sem_2_percentage2,
...
//   React.useEffect(() => {
//     if (isLateralEntry) {
//       setValue('twelfth_std_board', 'Lateral Entry');
//       setValue('twelfth_std_pass_out_year', 'Lateral Entry');
//       setValue('twelfth_pcm_avg_percentage', 'Lateral Entry');
//       setValue('pcm_percentage', 'Lateral Entry');
//       setValue('twelfth_std_maths', 'Lateral Entry');
//       setValue('twelfth_std_physics', 'Lateral Entry');
//       setValue('twelfth_std_chemistry', 'Lateral Entry');
//       setValue('twelfth_std_english', 'Lateral Entry');

//       setValue('imu_rank', 'Lateral Entry');
//       setValue('imu_sem_1_percentage', 'Lateral Entry');
//       setValue('imu_sem_2_percentage', 'Lateral Entry');
//     } else {
//       setValue('twelfth_std_board', '');
//       setValue('twelfth_std_pass_out_year', '');
//       setValue('twelfth_pcm_avg_percentage', '');
//       setValue('pcm_percentage', '');
//       setValue('twelfth_std_maths', '');
//       setValue('twelfth_std_physics', '');
//       setValue('twelfth_std_chemistry', '');
//       setValue('twelfth_std_english', '');

//       setValue('imu_rank', '');
//       setValue('imu_sem_3_percentage', '');
//       setValue('imu_sem_4_percentage', '');
//     }
...
//                     candidates.
//                     <input type='hidden' {...register('twelfth_std_board')} />
//                     <input type='hidden' {...register('twelfth_std_pass_out_year')} />
//                     <input type='hidden' {...register('twelfth_pcm_avg_percentage')} />
//                     <input type='hidden' {...register('pcm_percentage')} />
//                     <input type='hidden' {...register('twelfth_std_maths')} />
//                     <input type='hidden' {...register('twelfth_std_physics')} />
//                     <input type='hidden' {...register('twelfth_std_chemistry')} />
//                     <input type='hidden' {...register('twelfth_std_english')} />
//                   </div>
//                 )}
//               </div>
//             </div>
...
//                       <DetailItem
//                         label='Sem 1'
//                         name='imu_sem_5_percentage1_percentage'
...
//                       <DetailItem
//                         label='Sem 2'
//                         name='imu_sem_6_percentage2_percentage'
...
//                       <input type='hidden' {...register('imu_sem_7_percentage')} />
//                       <input type='hidden' {...register('imu_sem_8_percentage')} />
//                     </div>
//                   )}
//                   <DetailItem
//                     label='Sem 3'
//                     name='imu_sem_1_percentage3_percentage'
...
//                   <DetailItem
//                     label='Sem 4'
//                     name='imu_sem_2_percentage4_percentage'
...
//                   <DetailItem
//                     label='Sem 5'
//                     name='imu_sem_3_percentage5_percentage'
...
//                   <DetailItem
//                     label='Sem 6'
//                     name='imu_sem_4_percentage6_percentage'
...
//                   <DetailItem
//                     label='Sem 7'
//                     name='imu_sem_5_percentage7_percentage'
...
//                   <DetailItem
//                     label='Sem 8'
//                     name='imu_sem_6_percentage8_percentage'
//                     placeholder='e.g., 82.5'
//                     type='float'
//                     icon={Percent}
//                   />
