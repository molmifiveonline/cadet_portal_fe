        ...
        <div className="bg-white rounded-lg shadow-sm border p-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
            <button
              ...
              className={`text-center p-3 rounded-lg border transition-all shadow-sm hover:shadow-md hover:-translate-y-0.5 cursor-pointer ${statusFilter === "all" && activeTab === "cadets" ? "bg-blue-50 border-blue-300 ring-2 ring-blue-100" : "bg-white border-gray-200 hover:border-blue-300 hover:bg-gray-50"}`}
            >
            ...
            <button
              ...
              className={`text-center p-3 rounded-lg border transition-all shadow-sm hover:shadow-md hover:-translate-y-0.5 cursor-pointer ${statusFilter === "Eligible for Assessment" ? "bg-green-50 border-green-300 ring-2 ring-green-100" : "bg-white border-gray-200 hover:border-green-300 hover:bg-gray-50"}`}
            >
            ...
            <button
              ...
              className={`text-center p-3 rounded-lg border transition-all shadow-sm hover:shadow-md hover:-translate-y-0.5 cursor-pointer ${statusFilter === "Eligible for Interview" ? "bg-yellow-50 border-yellow-300 ring-2 ring-yellow-100" : "bg-white border-gray-200 hover:border-yellow-300 hover:bg-gray-50"}`}
            >
              <div className="text-2xl font-bold text-yellow-600">
                {stats.interview_selected}
              </div>
              <div className="text-sm text-gray-600">Interview Ready</div>
            </button>
            <button
              onClick={() => handlePipelineClick("Eligible for Medical")}
              className={`text-center p-3 rounded-lg border transition-all shadow-sm hover:shadow-md hover:-translate-y-0.5 cursor-pointer ${statusFilter === "Eligible for Medical" ? "bg-purple-50 border-purple-300 ring-2 ring-purple-100" : "bg-white border-gray-200 hover:border-purple-300 hover:bg-gray-50"}`}
            >
            ...
            <button
              ...
              className={`text-center p-3 rounded-lg border transition-all shadow-sm hover:shadow-md hover:-translate-y-0.5 cursor-pointer ${statusFilter === "Medical Completed" ? "bg-indigo-50 border-indigo-300 ring-2 ring-indigo-100" : "bg-white border-gray-200 hover:border-indigo-300 hover:bg-gray-50"}`}
            >
            ...
            <button
              ...
              className={`text-center p-3 rounded-lg border transition-all shadow-sm hover:shadow-md hover:-translate-y-0.5 cursor-pointer ${statusFilter === "CTV Assigned" ? "bg-amber-50 border-amber-300 ring-2 ring-amber-100" : "bg-white border-gray-200 hover:border-amber-300 hover:bg-gray-50"}`}
            >
            ...
            <button
              ...
              className={`text-center p-3 rounded-lg border transition-all shadow-sm hover:shadow-md hover:-translate-y-0.5 cursor-pointer ${statusFilter === "Onboarded" ? "bg-emerald-50 border-emerald-300 ring-2 ring-emerald-100" : "bg-white border-gray-200 hover:border-emerald-300 hover:bg-gray-50"}`}
            >
